...
permalink: "2025-08-01-how-to-use-icomoon-to-create-and-integrate-high-quality-vector-icon-fonts-part-1"
...
Once the IcoMoon App is open, you’ll see a grid of icons from the default IcoMoon - Free selection set. Take a few minutes to scroll through and explore. There’s a solid variety of common UI icons i.e arrows, social logos, interface symbols, and more. Or search for an icon you already have in mind.
...
>
> We’ll cover that in [Part 2](/blog/2025-08-11-how-to-use-icomoon-to-create-and-integrate-high-quality-vector-icon-fonts-part-2-icomoon-workflow), where I walk through integrating IcoMoon into a real front-end workflow.
...
```css title="style.css" showLineNumbers "../fonts"#v
@font-face {
  font-family: 'icomoon';
  src:  url('../fonts/icomoon.eot?tsq330');
  src:  url('../fonts/icomoon.eot?tsq330#iefix') format('embedded-opentype'),
...
In [Part 2](/blog/2025-08-11-how-to-use-icomoon-to-create-and-integrate-high-quality-vector-icon-fonts-part-2-icomoon-workflow), I’ll dive into how I organize my IcoMoon files, manage updates, and use these fonts in a real-world front-end workflow.
